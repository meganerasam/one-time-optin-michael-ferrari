...
// Redirection to "etude de cas"
exports.oneTimeOptInActiveCamapaignMichaelEtudeDeCas = async (req, res) => {
  try {
    // Variables
    let tagId = 152;
    let listId = 29;
    ...
    if (tagAdded && listAdded) {
      ...
      res
        .writeHead(307, {
          Location: `https://www.le-coloctionneur.fr/35-etudes-de-cas-colocation/`,
        })
        .end();
    } else if (tagAdded && !listAdded) {
      res
...
// Redirection to "Live"
exports.oneTimeOptInActiveCamapaignMichaelLive = async (req, res) => {
  try {
    // Variables
    let tagId = 152;
    let listId = 29;
    ...
    if (tagAdded && listAdded) {
      ...
      res
        .writeHead(307, {
          Location: `https://event.webinarjam.com/channel/live-micro-coloc`,
        })
        .end();
    } else if (tagAdded && !listAdded) {
      res
